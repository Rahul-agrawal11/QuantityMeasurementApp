...
public class QuantityMeasurementAppTest {
	...
	public void testAdditionExplicitTargetUnitYards() {
		Length length1 = new Length(1.0, Length.LengthUnit.FEET);
		Length length2 = new Length(12.0, Length.LengthUnit.INCHES);
		Length sumLength = QuantityMeasurementApp.demonstarteLengthAddition(length1, length2, Length.LengthUnit.YARDS);
	...
	public void testAdditionExplicitTargetUnitCommutativity() {
		...
		Length l1PlusL2 = QuantityMeasurementApp.demonstarteLengthAddition(l1, l2, Length.LengthUnit.YARDS);
		Length l2PlusL1 = QuantityMeasurementApp.demonstarteLengthAddition(l2, l1, Length.LengthUnit.YARDS);
		assertTrue(QuantityMeasurementApp.demonstrateLengthEquality(l1PlusL2, l2PlusL1));
	}
	...
	public void testAdditionExplicitTargetUnitNegativeValues() {
		Length length1 = new Length(5.0, Length.LengthUnit.FEET);
		Length length2 = new Length(-2.0, Length.LengthUnit.FEET);
		Length sumLength = QuantityMeasurementApp.demonstarteLengthAddition(length1, length2, Length.LengthUnit.INCHES);
